var thythemebjid=["#00a1d6","#15E3CE","#28FF28"];
...
var YZM = {
	...
	'start': function() {
		$.ajax({
			...
			success: function(e) {
				...
				config.color = thythemebj; //e.data.color;
	...
	'play': function(url) {
		...
		var doi = document.createElement('script'),
			...
			doi.id = 'thy_v1.0';
		/*注释 doi.type = 'text/javascript'; */
		/*注释 doi.src = ad + ae + af + agi + 'url=' + ac; */
